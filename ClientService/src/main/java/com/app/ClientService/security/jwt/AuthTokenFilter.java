package com.app.ClientService.security.jwt;

import com.app.ClientService.security.services.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                logger.info("JWT Token validated, username: " + username);
