...
public class RenteRequest {
    ...
    public RenteRequest(int date_Effet, int date_naissance, int durmois, String fract, String fract_rente, double mntprime_investi, double mntversemment_intial, double _Tx_indexation, double salaire_imposable, double _Tx_tmg, char typE_rente, int duree_rente_parAN, double frai_Service_Rente) {
        this.date_Effet = date_Effet;
        this.date_naissance = date_naissance;
        this.durmois = durmois;
        this.fract = fract;
