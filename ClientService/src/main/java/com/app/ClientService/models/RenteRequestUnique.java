...
public class RenteRequestUnique {
    ...
    public RenteRequestUnique(int date_Effet, int date_naissance, int durmois,  String fract_rente, double mntprime_investi, double salaire_imposable, char typE_rente, int duree_rente_parAN, double _Tx_tmg, double frai_Service_Rente) {
